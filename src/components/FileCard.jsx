...
export default function FileCard({ file, selected, onSelect, onClick, onCopy, onDelete, getFileUrl }) {
    ...
    >
      ...
      <div className="p-2">
        ...
        <div className="flex items-center justify-between mt-1">
          ...
          <span className="text-[10px] text-gray-400">{file.source === 'github' ? '📦' : file.source === 'r2' ? '☁️' : file.source === 'telegram' ? '✈️' : ''}</span>
        </div>
      </div>
    </div>
  )
